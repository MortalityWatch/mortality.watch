...
test.describe('Ranking Page', () => {
  ...
  test('should update rankings on browser back/forward navigation', { tag: '@flaky' }, async ({ page }) => {
    // Increase timeout for this test - multiple S3 fetches in CI can be slow
