  ...
  return {
    ...
    afterDraw: async (chart: Chart) => {
      ...
      if (showLogo) {
        ...
        await drawLogo(chart, isDarkMode, currentGeneration)
      }
    }
  }
}
